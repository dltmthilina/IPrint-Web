          ...
          <section className="relative py-24 px-6 lg:px-12 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto flex flex-col items-center text-center relative z-10">
              ...
              <p className="text-gray-400 text-lg md:text-xl max-w-3xl leading-relaxed font-light">
                Founded at the intersection of art and engineering, iprint3D
                began with a simple mission: to make high-end custom
                manufacturing accessible to everyone. Today, we're the leading
                platform for hyper-realistic 3D printed masterpieces.
              </p>
            </div>
          </section>
          ...
          <section className="py-12 border-y border-white/5 bg-surface-dark/30">
            <div className="max-w-7xl mx-auto px-6 lg:px-12">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                ...
                <div className="text-center">
                  <h3 className="text-4xl md:text-5xl font-bold text-tertiary mb-2">
                    99.9%
                  </h3>
                  <p className="text-sm text-gray-500 uppercase tracking-widest font-bold">
                    Quality Rate
            ...
            <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="flex flex-col gap-8">
                <h2 className="text-4xl md:text-5xl font-bold leading-tight">
                  Crafting <span className="text-primary italic">Quality</span>{" "}
                  without Compromise.
                </h2>
                <div className="flex flex-col gap-6 text-gray-400 text-lg leading-relaxed font-light">
                  <p>
                    We believe that every custom piece should be a work of art.
                    That's why we've invested in the latest UV-curing and
                    sublimation technologies that ensure your prints don't just
                    look good today, but stay vibrant for decades.
                  </p>
                  <div className="grid sm:grid-cols-2 gap-6 mt-4">
                    <div className="flex flex-col gap-3 p-6 rounded-2xl bg-surface-dark border border-white/5 hover:border-primary/50 transition-colors">
                      ...
                      <p className="text-sm">
                        Micron-level accuracy in every layer of the printing
                        process.
                      </p>
                    </div>
                    <div className="flex flex-col gap-3 p-6 rounded-2xl bg-surface-dark border border-white/5 hover:border-secondary/50 transition-colors">
                      ...
                      <p className="text-sm">
                        Eco-friendly resins and reduced-waste manufacturing
                        cycles.
                      </p>
                    </div>
                  </div>
