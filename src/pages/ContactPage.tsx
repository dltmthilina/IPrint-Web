              ...
              <div className="flex flex-col gap-10">
                <div className="flex flex-col gap-4">
                  ...
                  <h1 className="text-5xl md:text-7xl font-black leading-none">
                    Let's Create <br />
                    <span className="text-primary italic">Magic</span> Together.
                  </h1>
                  <p className="text-gray-400 text-xl font-light mt-4 max-w-lg">
                    Have a complex project or a unique idea? Our design team is
                    ready to help you bring it to life.
                  </p>
                </div>
                ...
                <form className="flex flex-col gap-6">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <textarea
                      ...
                      className="w-full bg-background-dark border border-white/10 rounded-2xl h-40 p-6 focus:border-primary focus:outline-none transition-colors resize-none"
                    ></textarea>
                  </div>
